...
public:
	...
	TSubclassOf<ABomba> ClaseBomba; // Aquí solo basta con forward declaration

	void ColocarBomba();
	// Esta es la función que se llama cuando presionas la tecla para cambiar el clima
	void AlternarClima(); // ? FUNCIÓN PARA CAMBIAR EL CLIMA
